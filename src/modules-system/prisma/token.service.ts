...
import { ACCESS_TOKEN_SECRET, REFRESH_TOKEN_SECRET } from "src/common/app.constant";
@Injectable()
export class TokenService {
    ...
    createRefreshToken(userId) {
        ...
        const refreshToken = jwt.sign({ userId: userId }, REFRESH_TOKEN_SECRET as string, { expiresIn: "7d" });
